...
public class ProjectileMoveScript_OG : MonoBehaviour
{
    ...
    //private RotateToMouseScript rotateToMouse; ERR
    ...
    {
        if (target != null)
            //rotateToMouse.RotateToMouse(gameObject, target.transform.position); ERR
        if (rotate)
